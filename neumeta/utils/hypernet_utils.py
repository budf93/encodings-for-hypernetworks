...
from neumeta.hypermodel import \
    NeRF_MLP_Compose_PE, NeRF_ResMLP_Compose_PE\
        , NeRF_MLP_Compose_GaussianRFF, NeRF_MLP_Compose_MultiResHashEncoding \
        , NeRF_ResMLP_Compose_GaussianRFF, NeRF_ResMLP_Compose_MultiResHashEncoding \
        , NeRF_ResMLP_Compose_NoEncodings
...
def get_hypernet(args, number_param, device='cuda'):
    ...
    if hyper_model_type == 'mlp_pe':
        hyper_model = NeRF_MLP_Compose_PE(
    ...
    elif hyper_model_type == 'mlp_hash_encoding':
        hyper_model = NeRF_MLP_Compose_MultiResHashEncoding(
            input_dim=args.hyper_model.input_dim,
            hidden_dim=args.hyper_model.hidden_dim,
            num_layers=args.hyper_model.num_layers,
            output_dim=args.hyper_model.output_dim,
    ...
    elif hyper_model_type == 'resmlp_pe':
        print("Using scalar", args.hyper_model.get('scalar', 0.1))
        hyper_model = NeRF_ResMLP_Compose_PE(
            input_dim=args.hyper_model.input_dim,
            hidden_dim=args.hyper_model.hidden_dim,
            num_layers=args.hyper_model.num_layers,
            output_dim=args.hyper_model.output_dim,
    ...
    elif hyper_model_type == 'resmlp_no_encodings':
        print("Using scalar", args.hyper_model.get('scalar', 0.1))
        hyper_model = NeRF_ResMLP_Compose_NoEncodings(
            input_dim=args.hyper_model.input_dim,
            hidden_dim=args.hyper_model.hidden_dim,
            num_layers=args.hyper_model.num_layers,
            output_dim=args.hyper_model.output_dim,
    ...
    elif hyper_model_type == 'resmlp_gaussian_rff':
        hyper_model = NeRF_ResMLP_Compose_GaussianRFF(
            input_dim=args.hyper_model.input_dim,
            hidden_dim=args.hyper_model.hidden_dim,
            num_layers=args.hyper_model.num_layers,
            output_dim=args.hyper_model.output_dim,
    ...
    elif hyper_model_type == 'resmlp_hash_encoding':
        hyper_model = NeRF_ResMLP_Compose_MultiResHashEncoding(
            input_dim=args.hyper_model.input_dim,
            hidden_dim=args.hyper_model.hidden_dim,
            num_layers=args.hyper_model.num_layers,
            output_dim=args.hyper_model.output_dim,
